...
class StrategyMidPt(BaseStrategy):
    """Strategy 2: Mid Point."""
...
# from scipy.special import softmax
# from typing import List
# from generation.grid_world.basics.grid import GridMap
# from generation.grid_world.strategies.base import BaseStrategy
#
#
# class StrategyMidPt(BaseStrategy):
#     """Strategy 2: Mid Point."""
...
#         return sorted(
#             x,
#             key=lambda x: self.layered_color_board[x[0], x[1], 0] + abs(
#                 target - self.layered_color_board[x[0], x[1], 1]) * 10000)[0]
#
#     def _path_next_greedily_safe(self, x, **kwargs):
#         """
#         greedily save adjustor: first greedy, then safe (far distance to other colors)
...
#             tmp += self.grid_map.dist_from_region(self.color_regions[silo])
#
#         return sorted(x, key=lambda coord: tmp[coord], reverse=True)[0]
#
#     def shortest_path_gen(self,
#                           this: tuple,
#                           other: tuple,
